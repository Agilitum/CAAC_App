package com.ludwig.caac_app.util;
...
public abstract class SystemUiHider {
	...
	public static final int FLAG_LAYOUT_STABLE = View.SYSTEM_UI_FLAG_LAYOUT_STABLE;

	public static final int FLAG_IMMERSIVE_STICKY = View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY;

	public static final int FLAG_IMMERSIVE = View.SYSTEM_UI_FLAG_IMMERSIVE;
	/**
